  ...
  <body style="font-size: 19px; max-width: 500px; margin: 0 auto; padding:3%">
    <div style="background-color: #fff;">
      ...
      <div style="text-align: center; background-color: #fff;">
        <h1 style="font-size: 25px; font-weight: 900; margin-top: 40px; text-align:center; padding-bottom:16px;">{{__('register.confirmation_email')}}</h1>
...
"
            >{{ strtoupper(__('register.verify_email' ))}}
         </a>
